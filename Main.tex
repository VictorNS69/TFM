...
\begin{otherlanguage}{spanish}
    ...
    \subsection{Contexto}
    \input{sections/intro/contexto}

    \subsection{Motivación}
    \input{sections/intro/motivacion}

    \subsection{Objetivos}
    \input{sections/intro/objetivos}

    \subsection{Estructura del documento}
    \input{sections/intro/estructura}

    \newpage
    \section{Estado del Arte}

    \subsection{Hacking Ético}
    \input{sections/stateOfTheArt/hackingEtico}

    \subsection{\acrlong{HTB}}
    \input{sections/stateOfTheArt/htb}
    ...
    \subsection{Anew}
    \input{sections/tools/anew}

    \subsection{Burp Suite}
    \input{sections/tools/burp}

    \subsection{Gobuster}
    \input{sections/tools/gobuster}

    \subsection{MSFvenom}
    \input{sections/tools/msfvenom}

    \subsection{Netcat}
    \input{sections/tools/netcat}

    \subsection{Nmap}
    \input{sections/tools/nmap}

    \subsection{PEASS-ng}
    \input{sections/tools/peass}

    \subsection{SecLists}
    \input{sections/tools/seclists}

    \subsection{Wireshark}
    \input{sections/tools/wireshark}

    \newpage
    \section{Máquina 1: \textit{Cap}}
    \input{sections/machines/cap}

    \newpage
    \section{Máquina 2: \textit{Seal}}
    \input{sections/machines/seal}
